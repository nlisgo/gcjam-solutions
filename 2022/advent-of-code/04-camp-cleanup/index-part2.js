...
const partiallyContains = ([startA, endA], [startB, endB]) => ((startA <= startB && endA >= startB) || (startA <= endB && endA >= endB) || (startB <= startA && endB >= startA) || (startB <= endA && endB >= endA));
